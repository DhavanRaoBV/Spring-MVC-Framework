...
<div class="card card-body " >
  ...
  <input type="Submit" class="btn btn-danger" value=add name=b1>
  <input type="Submit" class="btn btn-danger" value=sub name=b1>
  <input type="Submit" class="btn btn-danger" value=mul name=b1>
  <input type="Submit" class="btn btn-danger" value=div name=b1>
</form>
</div>
</div>
</div>
